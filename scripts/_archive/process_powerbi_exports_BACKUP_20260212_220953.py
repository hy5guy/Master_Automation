...
Handles fuzzy matching (e.g. "Average Response Times  Values" double space), skips Text Box / Administrative Commander.
"""
...
def find_mapping_for_file(config: dict, file_stem: str) -> tuple[dict | None, str | None]:
    ...
    Uses visual_name, match_pattern (regex), and match_aliases; normalizes spaces for matching.
    """
