...
✅ **Summons backfill** - `summons_backfill_merge.py` uses backfill as source of truth for all months in consolidated file; `2026_01_department_wide_summons_january_report.csv` (01-25 through 01-26); injection point at `docs/SUMMONS_BACKFILL_INJECTION_POINT.md`  
