...
// # Author: R. A. Carucci
// # Purpose: Load Traffic Bureau monthly activity metrics from contribution
// workbook.

let ReportMonth = pReportMonth,
    Source = Excel.Workbook(
        File.Contents(
            "C:\Users\carucci_r\OneDrive - City of Hackensack\Shared "
            "Folder\Compstat\Contributions\Traffic\Traffic_Monthly.xlsx"),
        null, true),
...
#"Changed Type" = Table.TransformColumnTypes(_mom_traffic_Table, {
    ...
    {"11-25", Int64.Type}, {"12-25", Int64.Type}, {
  "01-26", Int64.Type
}
}),
