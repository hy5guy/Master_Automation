...
let
    ...
    #"Changed Type" = Table.TransformColumnTypes(_mom_traffic_Table,{{"Tracked Items", type text}, {"06-23", Int64.Type}, {"07-23", Int64.Type}, {"08-23", Int64.Type}, {"09-23", Int64.Type}, {"10-23", Int64.Type}, {"11-23", Int64.Type}, {"12-23", Int64.Type}, {"01-24", Int64.Type}, {"02-24", Int64.Type}, {"03-24", Int64.Type}, {"04-24", Int64.Type}, {"05-24", Int64.Type}, {"06-24", Int64.Type}, {"07-24", Int64.Type}, {"08-24", Int64.Type}, {"09-24", Int64.Type}, {"10-24", Int64.Type}, {"11-24", Int64.Type}, {"12-24", Int64.Type}, {"01-25", Int64.Type}, {"02-25", Int64.Type}, {"03-25", Int64.Type}, {"04-25", Int64.Type}, {"05-25", Int64.Type}, {"06-25", Int64.Type}, {"07-25", Int64.Type}, {"08-25", Int64.Type}, {"09-25", Int64.Type}, {"10-25", Int64.Type}, {"11-25", Int64.Type}, {"12-25", Int64.Type}}),
...
let
    ...
    #"Changed Type" = Table.TransformColumnTypes(Table8_Table,{{"Date", type date}, {"Event", type text}, {"Notes", type any}, {"Duration", type any}, {"Location", type any}}),
...
// Top_5_All_Time
// ___Top_5_Arrests_ALL_TIME
// 🕒 2025-01-05-14-45-00
// Project: Arrest_Analysis/Top_5_All_Time
// Author: R. A. Carucci
// Purpose: Top 5 arrests WITHOUT date filter to verify query logic works
...
let
    ...
    #"Changed Type" = Table.TransformColumnTypes(Preview,{{"Arrest Date", type date}})
