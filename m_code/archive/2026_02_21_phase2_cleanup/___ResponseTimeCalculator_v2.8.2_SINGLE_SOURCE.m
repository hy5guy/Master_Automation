// ==============================================================================
// RESPONSE TIMES M CODE - FRESH CALCULATOR LOADER (v2.8.2 - Single Source)
// Query Name: ___ResponseTimeCalculator
// ==============================================================================
// UPDATE (v2.8.2 - 2026-02-09):
// - Changed to load ONLY from _DropExports folder (Fresh Calculator v3.0.0 output)
// - Removed multi-path fallback to prevent mixing fresh + old backfill data
// - Updated filter to match only "Average_Response_Times" pattern
// - Ensures consistent data from timereport recalculation
// ==============================================================================
...
let
    ...
    // UPDATED v2.8.2: Use ONLY Fresh Calculator output from _DropExports
    // This ensures we don't mix fresh data with old backfill/visual export data
    // Fresh Calculator v3.0.0 recalculates from raw timereport data for consistency
    ...
    // Filter: CSV files with "Average_Response_Times" pattern (Fresh Calculator output)
